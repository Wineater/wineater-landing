...
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "header" }, _attrs))} data-v-e6523421><div class="header__logo" style="${ssrRenderStyle({ "background-image": `url(${unref(store) && _ctx.logos[unref(store)] ? _ctx.logos[unref(store)] : _ctx.logos.Wineater})` })}" data-v-e6523421></div>`);
      if (__props.showLinks) {
        _push(`<div class="header__links" data-v-e6523421><div class="header__link p1 color-text" data-v-e6523421>${ssrInterpolate(_ctx.$t("Header.TryMe"))}</div><div class="header__link p1 color-text" data-v-e6523421>${ssrInterpolate(_ctx.$t("Header.HowItWorks"))}</div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="header__right-container" data-v-e6523421><div class="header__btns" data-v-e6523421>`);
      _push(ssrRenderComponent(LangSwitcher, null, null, _parent));
      _push(`<div class="header__btn" data-v-e6523421>`);
...
const Header = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e6523421"]]);

export { Button as B, Header as H };
//# sourceMappingURL=Header-rWhQKPAu.mjs.map

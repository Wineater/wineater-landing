...
import { resolveComponent, mergeProps, computed, toValue, reactive, ref, shallowRef, toRef, getCurrentInstance, onServerPrefetch, unref, useSSRContext } from 'vue';
import { ssrRenderComponent, ssrRenderAttrs } from 'vue/server-renderer';
import { _ as _export_sfc, f as fetchDefaults, c as useNuxtApp, d as asyncDataDefaults, g as useRequestFetch, e as createError } from './server.mjs';
import { W as hash } from '../runtime.mjs';
...
const baseApiUrl = "https://wineater-backend.vercel.app/";
const DemoToken = "Y3I8Pi1FruGjVmIBqpV24PtOLYjzdROuxWX9tCXh82zjz7uUPxV3ETvHhoeiLS17";
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div class="playground"><div id="wineater-widget-conteiner"></div></div><!--]-->`);
}
...
//# sourceMappingURL=playground-s2VD6cJc.mjs.map

import { getCurrentInstance, inject, unref, hasInjectionContext, shallowRef, computed, onUnmounted, version, defineComponent, h, ref, provide, createElementBlock, shallowReactive, watch, Suspense, nextTick, Transition, createApp, createVNode, Text, Fragment, toRef, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, reactive, effectScope, isReadonly, isReactive, toRaw, isRef, isShallow, useSSRContext } from 'vue';
import { h as createError$1, $ as $fetch, l as defu, m as createHooks, t as toRouteMatcher, n as createRouter$1, o as sanitizeStatusCode, p as destr, q as klona, r as parse$1, v as getRequestHeader, w as isEqual$1, x as setCookie, y as getCookie, z as deleteCookie, A as getRequestHeaders } from '../runtime.mjs';
...
const useRouter = () => {
  var _a;
  return (_a = /* @__PURE__ */ useNuxtApp()) == null ? undefined : _a.$router;
};
const useRoute = () => {
...
const navigateTo = (to, options) => {
  ...
  const isExternal = (options == null ? undefined : options.external) || hasProtocol(toPath, { acceptRelative: true });
  if (isExternal) {
...
const _routes = [
  {
    ...
    alias: [],
    redirect: undefined ,
    component: () => import('./_id_-B5sn0DGa.mjs').then((m) => m.default || m)
  },
  {
    name: "demo-id___fr",
    path: "/fr/demo/:id()",
  ...
  },
  {
    ...
    alias: [],
    redirect: undefined ,
    component: () => import('./index-ntv9aK3r.mjs').then((m) => m.default || m)
  },
  {
    name: "index___fr",
    path: "/fr",
  ...
  },
  {
    ...
    alias: [],
    redirect: undefined ,
    component: () => import('./playground-CyLhr5wx.mjs').then((m) => m.default || m)
  },
  {
...
const plugin = /* @__PURE__ */ defineNuxtPlugin({
  ...
  async setup(nuxtApp) {
    ...
    const routes = ((_b = routerOptions.routes) == null ? undefined : _b.call(routerOptions, _routes)) ?? _routes;
    let startPosition;
...
function getDomainFromLocale(localeCode) {
  ...
  const domain = ((_b = (_a = config == null ? undefined : config.locales) == null ? undefined : _a[localeCode]) == null ? undefined : _b.domain) ?? (lang == null ? undefined : lang.domain);
  if (domain) {
...
const runtimeDetectBrowserLanguage = (opts = (/* @__PURE__ */ useRuntimeConfig()).public.i18n) => {
  if ((opts == null ? undefined : opts.detectBrowserLanguage) === false)
    return false;
  ...
  async setup(nuxt) {
    ...
    if (runtimeI18n.experimental.switchLocalePathLinkSSR === true) {
      ...
      nuxt.hook("app:rendered", (ctx) => {
        var _a;
        if (((_a = ctx.renderResult) == null ? undefined : _a.html) == null)
          return;
...
export { _export_sfc as _, useI18n as a, useNuxtApp as b, asyncDataDefaults as c, createError as d, entry$1 as default, useRequestFetch as e, fetchDefaults as f, useRouter as g, injectHead as i, resolveUnrefHeadInput as r, useRoute as u };

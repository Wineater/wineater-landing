import { hasInjectionContext, inject, version, defineComponent, h, getCurrentInstance, onUnmounted, ref, provide, createElementBlock, shallowReactive, watch, Suspense, nextTick, Transition, unref, computed, Fragment, useSSRContext, createApp, effectScope, reactive, shallowRef, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRef, isReadonly, Text, isRef, isShallow, isReactive, toRaw } from 'vue';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./_id_-9X2Q-Q9b.mjs').then((m) => m.default || m)
  },
  {
    name: "demo-id___fr",
    path: "/fr/demo/:id()",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-BtRavbsS.mjs').then((m) => m.default || m)
  },
  {
    name: "index___fr",
    path: "/fr",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./playground-CIbc0G03.mjs').then((m) => m.default || m)
  },
  {

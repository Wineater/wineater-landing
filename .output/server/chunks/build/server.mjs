import { hasInjectionContext, inject, getCurrentInstance, shallowRef, computed, onUnmounted, ref, watchEffect, watch, unref, version, defineComponent, provide, createElementBlock, h, shallowReactive, Suspense, nextTick, Transition, createApp, createVNode, Text, Fragment, toRef, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, reactive, effectScope, isReadonly, isReactive, toRaw, isRef, isShallow, toValue, useSSRContext } from 'vue';
import { k as createError$1, $ as $fetch, v as defu, J as createHooks, K as toRouteMatcher, L as createRouter$1, M as sanitizeStatusCode, N as destr, O as klona, P as parse$1, Q as getRequestHeader, R as isEqual$1, S as setCookie, T as getCookie, U as deleteCookie, V as getRequestHeaders } from '../runtime.mjs';
...
const component_45stubQl7a60hcJV = {};
const _routes = [
  {
    name: "blog___en",
    path: "/blog",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./blog-CzdfiZw5.mjs').then((m) => m.default || m)
  },
  {
    name: "blog___fr",
    path: "/fr/blog",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./_id_-6_ta8Zzz.mjs').then((m) => m.default || m)
  },
  {
    name: "demo-id___fr",
    path: "/fr/demo/:id()",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./faq-BYMHeRlV.mjs').then((m) => m.default || m)
  },
  {
    name: "faq___fr",
    path: "/fr/faq",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-Dzuhg28i.mjs').then((m) => m.default || m)
  },
  {
    name: "index___fr",
    path: "/fr",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./playground-s2VD6cJc.mjs').then((m) => m.default || m)
  },
  {
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: component_45stubQl7a60hcJV
  }
];
...
const i18nPluginDeps = ["i18n:plugin"];
...
export { _export_sfc as _, useRoute as a, useI18n as b, useNuxtApp as c, asyncDataDefaults as d, entry$1 as default, createError as e, fetchDefaults as f, useRequestFetch as g, useRouter as h, useHead as u };

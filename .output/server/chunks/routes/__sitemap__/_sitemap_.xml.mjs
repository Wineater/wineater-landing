import { d as defineEventHandler, B as useSitemapRuntimeConfig, D as getRouterParam, k as createError, E as withoutLeadingSlash, F as withoutTrailingSlash, G as parseChunkInfo, H as getSitemapConfig, I as createSitemap } from '../../runtime.mjs';
import 'node:http';
import 'node:https';
import 'fs';
import 'path';

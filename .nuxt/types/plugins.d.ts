...
type NuxtAppInjections = 
  ...
  InjectionType<typeof import("../../plugins/gtm.client.js")> &
  InjectionType<typeof import("../../plugins/seo.client.js")> &
  InjectionType<typeof import("../../plugins/startTracker.client.js")> &
...
declare module '#app' {
  ...
  interface NuxtAppLiterals {
    pluginName: 'vue-devtools-client' | 'nuxt:revive-payload:client' | 'nuxt:head' | 'nuxt:router' | 'nuxt-site-config:init' | 'nuxt:browser-devtools-timing' | 'nuxt:payload' | 'nuxt:revive-payload:server' | 'nuxt:chunk-reload' | 'i18n:plugin:switch-locale-path-ssr' | 'i18n:plugin:route-locale-detect' | 'i18n:plugin' | 'nuxt-seo:fallback-titles' | 'nuxt-seo:defaults' | 'nuxt-schema-org:defaults' | 'nuxt:global-components' | 'nuxt:prefetch' | 'nuxt:checkIfPageUnused' | 'nuxt-site-config:i18n' | 'nuxt:checkIfLayoutUsed' | 'i18n:plugin:ssg-detect' | 'nuxt-schema-org:init'
  }
}

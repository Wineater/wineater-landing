import { reactive, hasInjectionContext, getCurrentInstance, version, unref, inject, toRef, isRef, nextTick, shallowRef, shallowReactive, isReadonly, isShallow, isReactive, toRaw, defineComponent, h, effectScope, onUnmounted, ref, computed, watch, Fragment, createVNode, Text, provide, Suspense, Transition, useSSRContext, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, defineAsyncComponent, createApp } from "vue";
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-979793b5.js").then((m) => m.default || m)
  },
  {
    name: "index___fr",
    path: "/fr",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/playground-466990f8.js").then((m) => m.default || m)
  },
  {
...
const localeMessages = {
  "en": [
    { key: "../locales/en.json", load: () => import(
      "./_nuxt/en-7c50b49c.js"
      /* webpackChunkName: "locale__workspaces_wineater_landing_locales_en_json" */
    ), cache: true }
  ],
  "fr": [
    { key: "../locales/fr.json", load: () => import(
      "./_nuxt/fr-b6fb6086.js"
      /* webpackChunkName: "locale__workspaces_wineater_landing_locales_fr_json" */
    ), cache: true }
  ]
};
...
function getDomainFromLocale(localeCode, locales, nuxt) {
  var _a, _b;
  const config = nuxt == null ? void 0 : nuxt.$config.public.i18n;
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/island-renderer-1c9e6efe.js").then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();

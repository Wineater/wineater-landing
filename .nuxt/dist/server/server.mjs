...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-183e64d4.js").then((m) => m.default || m)
  },
  {
    name: "index___fr",
    path: "/fr",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/playground-059149cd.js").then((m) => m.default || m)
  },
  {
...
const _sfc_main = {
  ...
  setup(__props) {
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/island-renderer-7582ee55.js").then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
